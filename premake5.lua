...
if string.lower(workspaceName) == "raygui" then
	print("raygui is a reserved name. Name your project directory something else.")
	-- Project generation will succeed, but compilation will definitely fail, so just abort here.
	os.exit()
end
...
for _, folderName in ipairs(folders) do
	...
	if string.starts(folderName, "raygui") == false and string.starts(folderName, ".") == false then
		if os.isfile(folderName .. "/premake5.lua") then
			print(folderName)
			include(folderName)
		end
